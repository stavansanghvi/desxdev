...
const ServiceCard: React.FC<ServiceCardProps> = (props) => {
  ...
  return (
    <div className="grid-item bg-black text-white overflow-hidden group w-[430px] h-[300px]  text-left relative">
      {/* Gradient Overlay */}
      <div
      ...
      <div className="absolute inset-0 inset-y-6 px-[44px] z-10">
